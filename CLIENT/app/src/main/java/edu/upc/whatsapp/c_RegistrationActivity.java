...
public class c_RegistrationActivity extends Activity implements View.OnClickListener {
  ...
  public void onClick(View arg0) {
    if (arg0 == findViewById(R.id.editregistrationButton)) {
      ...
      EditText loginText = (EditText) findViewById(R.id.RegisterLoginTextInput);
      String loginId = loginText.getText().toString();
      user.setLogin(loginId);

      EditText passwordText = (EditText) findViewById(R.id.RegisterPasswordTextInput);
      String password = passwordText.getText().toString();
      user.setPassword(password);

      EditText emailText = (EditText) findViewById(R.id.RegisterEmailTextInput);
      String email = emailText.getText().toString();
      user.setEmail(email);

      UserInfo userInfo = new UserInfo();
      EditText nameText = (EditText) findViewById(R.id.RegisterNameTextInput);
      String name = nameText.getText().toString();
      userInfo.setName(name);
      EditText surnameText = (EditText) findViewById(R.id.RegisterSurnameTextInput);
